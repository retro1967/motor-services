  ...
  if (data.length) {
    ...
    for (const i of data) {
      ...
      if ((i.mileage < 300) || (i.mileage % convOil) > 300) {
        ...
        td3.innerText = answer1 + " miles to go";
      ...
      if ((i.mileage < 300) || (i.mileage % synOil) > 300) {
        ...
        td4.innerText = answer2 + " miles to go";
      ...
      if ((i.mileage < 300) || (i.mileage % brakes) > 300) {
        ...
        td5.innerText = answer3 + " miles to go";
      ...
      if ((i.mileage < 300) || (i.mileage % tires) > 300) {
        ...
        td6.innerText = answer4 + " miles to go";
      ...
      if ((i.mileage < 300) || (i.mileage % filter) > 300) {
        ...
        td7.innerText = answer5 + " miles to go";
        ;
      } else {
